...
public class CocktailDto
{
    ...
    public List<CocktailDrink> CreateDomain()
    {
        ...
        foreach (var dto in Drinks)
        {
            ...
            for (int i = 0; i < 15; i++)
            {
                ...
                appendIng(ingList, ingVal, meaVal);
            }
    ...
    private static void appendIng(List<Ingredient> outp, string ing, string mea)
    {
        if (string.IsNullOrEmpty(ing) || string.IsNullOrEmpty(mea))
        {
            return;
        }
